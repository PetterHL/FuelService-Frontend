...
public class BottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            //Generates a picture for the corresponding fuel station.
            if (name.equals("Circle k")) {
            ...
            if (name.equals("Shell")) {
                Glide.with(requireContext())
                        .asBitmap()
                        .load("https://kommunikasjon.ntb.no/data/images/00276/293cf853-0336-4967-ab0f-37289ba4b9f1-w_300_h_100.png")
                        .into(imageSheet);
            }
            if (name.equals("Esso")) {
                Glide.with(requireContext())
    ...
    /**
     * @param context
     * This method is used to load the toggle state
     */
    ...
    /**
     * Makes a call to the backend to get the favorite stations based on the user logged in.
     */
    ...
    /**
     * Makes a call to the backend to remove selected station from favorites.
     */
